  ...
  if(e.key === 'Enter'){
    if(result === ""){
      ...
      if (y === -1){
        ...
        if(result === "rowan mercier" || result === "cd rowan mercier" || result === "cd rowan\\ mercier/" || result === "rowan\\ mercier/" || result === "cd"){
          y ++;
      ...
      if (y === -1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Rowan MERCIER:~$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else if (y === 1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Rowan MERCIER:~/portfolio/themes$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else {
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Rowan MERCIER:~/portfolio$</p><input type="text" autofocus class="input" id="input${i}" tabindex="-1">`);
      }
      document.getElementById(`input${i}`).focus();
