...
const getCv = () =>{
  ...
  a.href = "ressources/CV-RowanMERCIER.pdf";
  a.setAttribute("download", "CV-RowanMERCIER.pdf");
...
const getLinkedin = () =>{
  ...
  const a = document.createElement("a");
  a.href = "https://linkedin.com/in/rowan-mercier";
  a.setAttribute("target", "blank");
  a.click();
}
...
const getGithub = () =>{
  ...
  const a = document.createElement("a");
  a.href = "https://github.com/RowanMrc";
  a.setAttribute("target", "blank");
  a.click();
}
...
const ls = (y, result, secret) =>{
  if(y === 0 && result === "ls -a"){
    ...
    terminal.insertAdjacentHTML("beforeend", 
          `<div class="result ls">
            <div>list-secret</div>
            <div><code>Rowan MERCIER</code></div>
          </div>`);
  } else if (y === -1 && result === "ls -a"){
    terminal.insertAdjacentHTML("beforeend",  
    `<div class="result ls">
